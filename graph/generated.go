...
type Resolvers interface {
	Mutation_createTodo(ctx context.Context, input model.NewTodo) (model.Todo, error)
	Query_todos(ctx context.Context) ([]model.Todo, error)

	Todo_user(ctx context.Context, obj *model.Todo) (model.User, error)
}
...
func (s shortMapper) Mutation_createTodo(ctx context.Context, input model.NewTodo) (model.Todo, error) {
	return s.r.Mutation().CreateTodo(ctx, input)
}

func (s shortMapper) Query_todos(ctx context.Context) ([]model.Todo, error) {
	return s.r.Query().Todos(ctx)
}

func (s shortMapper) Todo_user(ctx context.Context, obj *model.Todo) (model.User, error) {
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Mutation_createTodo(ctx, args["input"].(model.NewTodo))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
// nolint: gocyclo, errcheck, gas, goconst
func (ec *executionContext) _Todo(ctx context.Context, sel []query.Selection, obj *model.Todo) graphql.Marshaler {
...
func UnmarshalNewTodo(v interface{}) (model.NewTodo, error) {
